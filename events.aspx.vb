...
Partial Class events
    ...
    Protected Sub Page_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        ...
        If Integer.TryParse(newsIDquery, newsID) = True Then
            eventPostings.Text = loadEvents(webFunc.getAccountAuth(g_email), newsID, True, False)
        Else
            eventPostings.Text = loadEvents(webFunc.getAccountAuth(g_email), 0, False, False)
        End If
