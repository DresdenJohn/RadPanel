...
Partial Class Admin_editPost
    ...
    Public Sub loadNewsEdit(ByVal ID As Integer)
        ...
        Dim queryString As String = "SELECT * FROM WEB_NEWSMAIN_TBL WHERE ID = " + ID.ToString
    ...
    Public Sub updateNews(ByVal id As String)
        ...
        Dim queryString As String = "UPDATE WEB_NEWSMAIN_TBL SET n_Title = '" + newsTitleTextBox.Text + "', n_Authority = '" + auth + "', n_News = '" + Server.HtmlEncode(NewsPosting.Text) + "' WHERE ID = " + id
